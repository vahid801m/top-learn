...
namespace TopLearn.DataLeyer.Migrations
{
    ...
    [Migration("20230318081425_AddChangIsTrueAnswer")]
    partial class AddChangIsTrueAnswer
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TopLearn.DataLeyer.Entities.Course.CourseVote", b =>
                {
            ...
            modelBuilder.Entity("TopLearn.DataLeyer.Entities.Question.Answer", b =>
                {
            ...
            modelBuilder.Entity("TopLearn.DataLeyer.Entities.Question.Question", b =>
                {
                    b.Property<int>("QuestionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<DateTime>("CreateQuestion")
                        .HasColumnType("datetime2");

                    b.Property<DateTime>("ModifiedQuestion")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("TopLearn.DataLeyer.Entities.Question.Answer", b =>
                {
                    b.HasOne("TopLearn.DataLeyer.Entities.Question.Question", "Question")
                        .WithMany("Answers")
